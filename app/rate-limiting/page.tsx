    ...
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Monitor and manage API rate limiting across your application</p>
        </div>
        ...
        <TabsContent value="overview" className="space-y-4">
            ...
            {Object.entries(stats).map(([type, data]) => (
              <Card key={type}>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium capitalize">{type} Requests</CardTitle>
                  <Activity className="h-4 w-4 text-muted-foreground" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">{data.totalAttempts.toLocaleString()}</div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Most common failure reasons across all endpoints</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="configs" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Current rate limiting settings for each endpoint type</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  <div key={index} className="border rounded-lg p-4">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center space-x-2">
                        ...
                        <h3 className="font-semibold capitalize">{config.type}</h3>
                      </div>
                      <Badge className={getAlgorithmBadgeColor(config.algorithm)}>
                        {config.algorithm}
                      </Badge>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">{config.windowMinutes} min</p>
                      </div>
                      <div>
                        <span className="font-medium">Lockout</span>
                        <p className="text-gray-600">{config.lockoutMinutes} min</p>
                      </div>
                      <div>
                      ...
                      <div className="mt-3 pt-3 border-t">
                        <div className="grid grid-cols-2 gap-4 text-sm">
                          ...
                          <div>
                            ...
                            <p className="text-gray-600">{config.refillRate}/min</p>
                          </div>
                        </div>
                      </div>
                    )}
        ...
        <TabsContent value="active" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Current rate limit status for active users and IPs</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  <div key={index} className="border rounded-lg p-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div>
                        ...
                        <p className={`${limit.locked ? 'text-red-600' : 'text-green-600'}`}>
          ...
          <div className="space-y-4">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Set up alerts for rate limiting events</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-3 border rounded">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Alert when failure rate exceeds 10%</p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 border rounded">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Alert when traffic increases by 50%</p>
                    </div>
                    <Badge variant="secondary">Active</Badge>
                  </div>
                  <div className="flex items-center justify-between p-3 border rounded">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">Alert when 5+ users are locked out</p>
                    </div>
