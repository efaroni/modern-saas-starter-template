...
test.describe('Authentication Accessibility Tests', () => {
  ...
  test.describe('Sign Up Page Accessibility', () => {
    test('should have no accessibility violations on sign up page', async ({
      page,
    }) => {
    ...
    test('should be navigable with keyboard only', async ({ page }) => {
      ...
      await expect(
        page.locator('[data-testid="signup-password"]'),
      ).toBeFocused();
  ...
  test.describe('Sign In Page Accessibility', () => {
    test('should have no accessibility violations on sign in page', async ({
      page,
    }) => {
  ...
  test.describe('Password Reset Page Accessibility', () => {
    test('should have no accessibility violations on password reset page', async ({
      page,
    }) => {
  ...
  test.describe('Email Verification Page Accessibility', () => {
    test('should have no accessibility violations on email verification page', async ({
      page,
    }) => {
  ...
  test.describe('Error Handling Accessibility', () => {
    test('should properly announce errors to screen readers', async ({
      page,
    }) => {
    ...
    test('should have proper error summary for multiple errors', async ({
      page,
    }) => {
