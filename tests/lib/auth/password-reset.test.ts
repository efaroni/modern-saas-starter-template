...
describe('Password Reset', () => {
  ...
  beforeEach(async () => {
    ...
    mockEmailService = (require('@/lib/email/service').emailService as MockEmailService)
  ...
  describe('Password Reset Request', () => {
    ...
    it('should generate unique reset tokens', async () => {
      const result1 = await authService.requestPasswordReset('reset@example.com')
      const result2 = await authService.requestPasswordReset('reset@example.com')
  ...
  describe('Password Reset Completion', () => {
    ...
    it('should invalidate token after successful reset', async () => {
      // First reset
      const result1 = await authService.resetPassword(resetToken, 'newpassword123')
      expect(result1.success).toBe(true)
      
      // Try to use same token again
      const result2 = await authService.resetPassword(resetToken, 'anothernewpassword')
